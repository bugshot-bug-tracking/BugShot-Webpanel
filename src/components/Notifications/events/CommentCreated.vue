<template>
	<NotificationTemplate>
		<template #header>
			<n-text>
				<i18n-t keypath="new_comment_on_bug" scope="global">
...
import { CommentCreated } from "~/models/NotificationTypes/CommentCreated";
import dateFix from "~/util/dateFixISO";

const props = defineProps({
	value: {
		type: Object as PropType<CommentCreated>,
		required: true,
	},
});
